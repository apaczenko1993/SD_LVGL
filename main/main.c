...
void list_files_on_sd_card(void *arg) {
    ...
    while ((entry = readdir(dir)) != NULL) {
		char full_path[256];  // Zwiększ rozmiar bufora
        //snprintf(full_path, sizeof(full_path) -1, "/sdcard/%s", entry->d_name);
...
{	
    ...
    //xTaskCreate(list_files_on_sd_card, "SDWORK", EXAMPLE_LVGL_TASK_STACK_SIZE, NULL, 3, NULL);
